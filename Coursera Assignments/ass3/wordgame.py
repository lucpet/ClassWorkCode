...
def make_str_from_column(board, column_index):
    ...
    result_word = ''
    for row in board:
        result_word = result_word + row[column_index]
    return result_word 
...
def read_words(words_file):
    ...
    #f = open(words_file, 'r')
    words_lists = words_file.readlines()
    for i in range(len(words_lists)):
        
        words_lists[i] = words_lists[i].rstrip()
...
def read_board(board_file):
    ...
    '''
    #f = open(board_file)
    words_lists = board_file.readlines()
    board_file.close()
    for i in range(len(words_lists)):
    ...
    lis = [list(x) for x in words_lists]
    return lis
